...
def get_hello(name=None):
    ...
    return template('templates/views/hello.tpl', name=username, color=favcolor)
...
def get_login():
    ...
    save_session(session, response)
    return template('templates/views/signup.tpl', message='')
...
def get_login():
    ...
    session['username'] = 'guest'
    save_session(session, response)
    return template('templates/views/login.tpl', message='')
